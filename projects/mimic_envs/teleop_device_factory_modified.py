...
# Try to import Se3LeaderArm (may not be available in all installations)
with contextlib.suppress(ModuleNotFoundError, ImportError):
    from isaaclab_mimic.controll_scripts.input_devices.se3_leader_arm import Se3LeaderArm, Se3LeaderArmCfg
...
# Add Se3LeaderArm if available
with contextlib.suppress(NameError):
    DEVICE_MAP[Se3LeaderArmCfg] = Se3LeaderArm
