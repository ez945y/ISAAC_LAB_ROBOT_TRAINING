...
def some_public_function(x: int):
    print("[rl_direct_hand_locomotion] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[rl_direct_hand_locomotion] startup")
    ...
    def on_shutdown(self):
        print("[rl_direct_hand_locomotion] shutdown")